...
<section class="page-hero">
    <div class="container">
        ...
        <p>
            ...
            app, siti web, strumenti digitali e idee in continua evoluzione.
        </p>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="project-showcase-card">
            <div class="project-showcase-content">
                ...
                <p>
                    PocketPlan è un gestionale personale pensato per aiutare le persone
                    a tenere sotto controllo entrate, spese, obiettivi e budget mensile
                    in modo semplice, chiaro e intelligente.
                </p>

                <p>
                    Il progetto integra funzionalità di intelligenza artificiale per analizzare
                    l’andamento finanziario, suggerire azioni utili e aiutare l’utente a prendere
                    decisioni più consapevoli nella gestione dei propri soldi.
                </p>
                ...
                <div class="project-actions">
                    <a href="{{ route('projects.pocketplan') }}" class="btn btn-primary">
            ...
            <div class="project-showcase-side">
                <div class="project-big-icon">PP</div>

                <ul class="project-points">
                    <li>Gestione entrate e spese</li>
                    <li>Obiettivi di risparmio</li>
                    <li>AI Planner finanziario</li>
                    <li>Dashboard chiara e moderna</li>
                </ul>
            </div>
        </div>
